...
void DCL00() {
  ...
  float degrees = 360.0 / ((float) random());
  float radians;
  /* ... */
...
void DCL32() {
  int *a_global_symbol_definition_lookup_table = NULL;
  int *b_global_symbol_definition_lookup_table = NULL;
